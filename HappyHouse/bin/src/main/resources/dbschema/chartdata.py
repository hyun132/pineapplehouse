            ...
            for n in range(len(apt_list)):#아파트 마다 하나씩 저장
                ...
                for i in range(len(area_list)):
                    ...
                    try:
                        obj = {
                            'aptCode' : keys,
                            'marketPrice': temp_price["marketPriceXList"],
                            'upperMarketPrice': temp_price["upperMarketPriceYList"],
                            'lowerMarketPrice': temp_price["lowerMarketPriceYList"],
                            'ChartBasisDate': temp_price["marketPriceChartBasisYearMonthDay"]
                        }
