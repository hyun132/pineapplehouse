...
for m in range(1,len(sido_list)):
    ...
    for j in range(5,len(gungu_list)):#구 마다 하나씩 저장
        ...
        # for k in range(1,3):#동마다 하나씩 저장
            ...
            for n in range(1,len(apt_list),5):#아파트 마다 하나씩 저장
                    ...
                    for i in range(len(area_list)):
                        ...
                        try:
                            print(temp["complexDetail"]["address"], temp["complexDetail"]["complexName"],
                                  'https://landthumb-phinf.pstatic.net' + temp["photos"][0]["imageSrc"])
                            temp_data.loc[i,"representativePhoto"]= 'https://landthumb-phinf.pstatic.net'+temp["photos"][0]["imageSrc"]
                        except Exception:
